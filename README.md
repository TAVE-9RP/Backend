...
![ERD 이미지](https://github.com/user-attachments/assets/a94e36ca-5128-4d57-a061-0c86a35b589a)

| 테이블명               | 설명                   | 
|:-------------------|:---------------------| 
| **Member**         | **회원 정보**            | 
| **Company**        | **회사 정보**            | 
| **Project**        | **회사가 생성한 프로젝트 정보**  |
| **Member_Project** | **회원-프로젝트 연결 테이블**   | 
| **Logistics**      | **프로젝트의 물류 서비스 정보**  |
| **Inventory**      | **프로젝트의 재고 서비스 정보**  | 
| **Item**           | **물류/재고 서비스의 물품 정보** | 
| **Logistics_Item** | **물류 서비스-물품 연결 테이블** | 
| **Inventory_Item** | **재고 서비스-물품 연결 테이블** | 
