...
public class LogisticsItemsUpdateRequest {

  @NotEmpty(message = "최소 하나 이상의 물품을 선택해야 합니다.")
  @Valid
  private List<UpdateLogisticsItemDetail> items;

  @Getter
  @NoArgsConstructor
  @AllArgsConstructor
  public static class UpdateLogisticsItemDetail {

    @NotNull(message = "물품(Inventory) ID는 필수입니다.")
    private Long itemId;

    @NotNull(message = " 출하 수량은 필수입니다.")
    @Min(value = 1, message = "출하 수량은 1개 이상이어야 합니다.")
