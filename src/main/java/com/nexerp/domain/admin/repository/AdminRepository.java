...
public interface AdminRepository extends JpaRepository<Member, Long> {
  ...
  List<Member> findByCompanyIdAndIdNotOrderByJoinRequestDateAsc(Long companyId,
  ...
  //회사 관리자 조회
  List<Member> findByCompanyIdAndPermissions_ManagementRole(Long companyId,
    MemberRole managementRole);
}
